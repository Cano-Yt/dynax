...
exports.run = async(client, message, args) => {
    ...
    let kanal = client.channels.cache.find(c => c.id === "810750526106763324")
  ...
  if(dil = "EN") {return message.channel.send(`Please write your request`)}
    ...
    if(dil = "TR") {
      message.channel.send(`İsteğiniz başarıyla sistemimize bildirilmiştir. En yakın zamanda yapılacaktır`)
